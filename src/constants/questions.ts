...
import { LucideIcon,User,Book,ChartPie,TrendingUp,Share2,Users } from "lucide-react";

export interface Field {
  title: string;
  category: "text" | "number" | "date" | "dropdown" | "email" | "text" | "multiselect";
  slug: string;
  options?: string[];
}
...
export const CREATOR_QUESTIONS: Questions = {
  ...
  step4: {
    title: "Growth Rate",
    icon: TrendingUp ,
    description: "Tell us a bit about your growth rate.",
    fields: [
      {
        title:"How many followers do you have on your primary social media?",
        slug:"primary-social-media-followers",
        category:"number"
      },
      {
        title:"Enter the link to your primary social media?",
        slug:"primary-social-media-link",
        category:"text"
      },
      {
        title:"How many followers do you have on your secondary social media?",
        slug:"secondary-social-media-followers",
        category:"number"
      },
      {
        title:"Enter the link to your secondary social media?",
  ...
  step5: {
    ...
    fields: [
      ...
      {
        title:"What are the top three primary geographic locations of your audience?",
