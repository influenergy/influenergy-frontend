  ...
  return (
    <FormProvider {...methods}>
      ...
      >
        ...
        <div className="mt-8 w-full max-w-5xl flex items-center justify-between">
          <Button
            type="button"
            variant="outline"
            onClick={handleSkip}
            className="w-1/3 px-6 py-5 hover:bg-gray-50"
          ...
          <Button
            className="w-1/3 px-6 py-5 bg-primary hover:bg-[#6564d8] text-white rounded-lg transition-colors duration-200
