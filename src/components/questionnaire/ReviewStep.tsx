  ...
  return (
    <div className="w-full mx-auto py-4 px-2 sm:py-8 sm:px-4 relative dark:text-gray-100 ">
      <div className="mb-6 flex flex-col justify-center items-center">
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mt-4 mb-2 text-center text-gray-900 dark:text-gray-100">
        ...
        {sections.map((section) => (
          <div key={section.title}>
            <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-2">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-200 flex items-center gap-2">
