...
export default function ProfileMatch() {
  ...
  const featuredCreators: CreatorAPIResponse[] = creatorsData?.data?.featuredCreators || [];
    ...
    <div className="container mx-auto mt-8 px-4 sm:px-5">
...

      {
        favCreators.length > 0 && <>
          <h2 className="text-2xl font-bold mb-4 border rounded-lg p-2 w-fit">Favorite Creators</h2>
          <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 w-full mb-4 md:mb-6">
              ...
              >
                <div className="relative w-full pt-[60%]">
                  ...
                  <div className="absolute top-0 right-1 bg-primary px-2 rounded-xl">
                    <span className="text-sm text-white">Matched {Math.round(data?.similarity * 100)}% </span>
                  </div>
                </div>
                <div className="flex flex-col p-3 sm:p-4 flex-grow dark:bg-gray-300">
                  <div className="flex items-start justify-between mb-2 dark:bg-gray-300">
      ...
      }
      {
        featuredCreators.length > 0 && <>
          <h2 className="text-2xl font-bold mb-4 border rounded-lg p-2 w-fit">Featured Creators</h2>
          <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 w-full mb-4 md:mb-6">
            {featuredCreators.map((data: CreatorAPIResponse) => {
              const badge = data?.creator.badge
              const level = Levels.filter(l => l.key === badge)[0]
              return <div
                key={data?.creatorId}
      ...
      <h2 className="text-2xl font-bold mb-4 border rounded-lg p-2 w-fit">Creators</h2>
