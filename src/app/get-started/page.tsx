          ...
          <div className="space-y-8 flex flex-col justify-center px-4 sm:px-6 md:px-10 h-full py-8 md:py-0">
            ...
            >
              <div className="space-y-4 sm:space-y-5 pl-2 sm:pl-6 md:pl-10">
                <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5x font-poppins font-medium">
                  Welcome back to <br />
                  <span className="text-primary font-bold font-mona leading-normal">
                    Influenergy
                  </span>
                </h1>
                <p className="mt-3 sm:mt-5 text-base sm:text-lg md:text-xl text-gray-800 font-poppins">
                Your Premier Influencer & UGC Marketing Agency
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                <div className="flex cursor-pointer h-40 sm:h-48 w-full sm:w-52 flex-col justify-between rounded-2xl bg-[#F2F2FF] p-4 sm:p-6 transition-all hover:bg-[#7C3AED] hover:text-white">
                  ...
                  />
                  <div>
                    <p className="text-xs sm:text-sm font-poppins">I&apos;m a</p>
          ...
          <motion.div className="relative bg-primary h-full hidden lg:block">
            ...
            <div className="flex flex-col justify-end items-center h-full w-full ml-4 xl:ml-10 ">
              <Image
                ...
                width={180}
                height={180}
                className="object-contain lg:mb-10"
                priority
              />
            </div>
          </motion.div>
